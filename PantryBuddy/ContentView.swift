...
private enum ProductLookupFailure: Equatable {
    ...
    var message: String {
        switch self {
        case .productNotFound:
            return "Non ho trovato questo prodotto nel catalogo online. Puoi inserirlo manualmente."

        case .invalidBarcode:
            return "Il codice letto non sembra essere un barcode prodotto valido. Prova a scansionarlo di nuovo."

        case .noConnection:
            return "Controlla Wi-Fi o rete mobile, poi premi Riprova."

        case .serviceUnavailable:
            return "Open Food Facts non risponde in questo momento. I dati già salvati restano disponibili."

        case .unknown:
            return "Si è verificato un problema imprevisto. Puoi riprovare o inserire il prodotto manualmente."
        }
    }
